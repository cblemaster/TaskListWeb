...
INSERT INTO task (task_name, created_date, due_date, reminder, recurrence_id, is_complete, is_important, folder_id) VALUES ('Commit yesterday''s homework to Bitbucket', GETDATE(), GETDATE() + 7, GETDATE() + 7, 1, 0, 1, (SELECT folder_id FROM folder WHERE folder_name='Tech Elevator - Technical'));
...
INSERT INTO task (task_name, created_date, due_date, reminder, recurrence_id, is_complete, is_important, folder_id) VALUES ('Go for a hike', GETDATE(), GETDATE() + 7, GETDATE() + 7, 6, 0, 1, (SELECT folder_id FROM folder WHERE folder_name='Self-care'));
